...
function setContentFromContainersTable() {
  ...
  setDataToContainers();
  itemsLeft.textContent = `${i} items left`;
  i = 0;
}
    ...
    const containerTemplate = `
        <div data-id="${idx}" class="container">
            <div class="checkbox-wrapper">
                <div data-clicked="false" data-id="${idx}" data-theme="${theme}" class="fake-button-border">
                    <div data-id="${idx}" class="fake-button" data-clicked="false" data-theme="${theme}">
            ...
            <div class="container-text-content"><div class="text-holder" data-id="${idx}" data-crossed="false" data-theme="${theme}">${todoInput.value}</div> <div class="cross-icon-wrapper"><svg class="cross-icon" data-id="${idx}" data-hidden="true" xmlns="http://www.w3.org/2000/svg" width="18" height="18"><path fill="#494C6B" fill-rule="evenodd" d="M16.97 0l.708.707L9.546 8.84l8.132 8.132-.707.707-8.132-8.132-8.132 8.132L0 16.97l8.132-8.132L0 .707.707 0 8.84 8.132 16.971 0z"/></svg></div></div>
        </div>
        <div id="hr" data-theme="${theme}"></div>`;
...
itemsLeft.textContent = `${content.length} items left`;
